...
def generate_confusion_matrix(eval_pred, eval_y, save_dir, save_name):
	###covert one-hot encoding into integer
	...
	confusion_matrix_df = pd.DataFrame(confusion_matrix(y, pred)).rename(columns=idx2class, index=idx2class)
